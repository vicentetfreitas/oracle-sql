...
--
-- Author: Vicente Freitas ( customized course )
--
-- PL/SQL Fundamentals - Installation and Configuration of connections in Oracle SQL Developer
--
-- Populating HR user schema objects

-- Populating HR user schema objects

/*
  In Oracle SQL Developer connect as user HR using your connection for user HR
  Open this script in Oracle SQL Developer and run (F5)
/*

/*
   Populates HR schema tables
*/
